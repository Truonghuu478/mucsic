...
const listMusic = [
  { song: "anh_nang_cua_anh", author: "Hữu Trường - cover" },
  { song: "song", author: "Hữu Trường - cover" },
  { song: "ai_oi_nghe_nay", author: "Hữu Trường - cover" },
  { song: "hom_nay_toi_buon", author: "Hữu Trường - cover" },
];
...
class UI {
  ...
  loadSong(music) {
    ...
    this.getDuration(audio).then((time) => {
      // image/${music.song}.jpg
      thumbnailSong.src = `./image/mucsic.jpg`;
